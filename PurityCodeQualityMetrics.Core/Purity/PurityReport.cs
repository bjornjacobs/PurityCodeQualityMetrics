...
public class PurityReport
{
    ...
    {
        get => JsonSerializer.Serialize(Violations);
        set => Violations = JsonSerializer.Deserialize<List<PurityViolation>>(value)!;
    }

    public string ParameterTypesJson
    {
        get => JsonSerializer.Serialize(ParameterTypes);
        set { ParameterTypes = JsonSerializer.Deserialize<List<string>>(value)!; }
    }
}
